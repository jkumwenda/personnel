...
<div class="container bg-secondary-subtle text-dark">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="my-3">Your application with ID {{ $application_id }} has been approved. </p>
            <p class="my-3">You can now login to the system to make your payments and register for your exam.</p>
