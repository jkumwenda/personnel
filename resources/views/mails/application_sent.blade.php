    ...
    <div class="container bg-secondary-subtle text-dark">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="my-3">Your application has been sent successfully. You will receive an email once your application has been approved.</p>
                <p>Your application ID is <b>{{ $application_id }}.</b></p>
